            ...
            >
                <div
                    className={cn(
                        ...
                        gradient,
                        "backdrop-blur-[2px] border-2 border-primary/[0.2]",
                        "shadow-[0_8px_32px_0_rgba(159,226,191,0.15)]",
                        "after:absolute after:inset-0 after:rounded-full",
                        "after:bg-[radial-gradient(circle_at_50%_50%,rgba(159,226,191,0.25),transparent_70%)]"
                    )}
                />
            </motion.div>
        </motion.div>
        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <ElegantShape
                    ...
                    height={120}
                    rotate={-15}
                    gradient="from-destructive/[0.18]"
                ...
                <ElegantShape
                    ...
                    height={60}
                    rotate={20}
                    gradient="from-primary-light/[0.22]"
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-card/50 border border-primary/[0.2] mb-8 md:mb-12"
                    >
                    ...
                    <motion.div
                        ...
                        animate="visible"
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-heading font-bold mb-6 md:mb-8 tracking-tight">
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-muted-foreground/80 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Отслеживай энергию, предотвращай выгорание, живи осознанно
                        </p>
                    </motion.div>
                </div>
            </div>
